        ...
        <div className="top_header_wrapper">
            ...
            <div className="user_profile_wrapper">
                <div className="notification_icon_wrapper">
                    <FontAwesomeIcon icon={faBell} className="notification_icon fontAwesome_icon" onClick={() => { router.push("/dashboard/notification") }} />
                    {
