...
const AcceptMaterial = () => {
  ...
  const handleCheckboxChange = (rowId, option) => {
    setRowSelections((prevSelections) => {
      const currentSelection = prevSelections[rowId];
      // Check if the current option is already selected
      if (currentSelection === option) {
        // Deselect if the same option is selected
        const { [rowId]: _, ...rest } = prevSelections; // Remove the entry
        return rest; // Return new selections without this material
      } else {
        // Select this option
        return { ...prevSelections, [rowId]: option }; // Update selection
      }
    });
  };
                          ...
                          <div className="col_40p">
                            <div className="check_box me-1" style={{ gap: "0" }}>
                              <input
                                ...
                                // onChange={handleSelectAllNonMaterials}
                                // checked={allNonMaterialsSelected}
                                id={`dumpCheckbox-${product.materialId}`}
                                onChange={() => handleCheckboxChange(product.materialId, "Yes")}
                                checked={rowSelections[product.materialId] === "Dump"}
                                // onClick={() => handleEditClick(index)}
                              />
                              {/* {console.log(rowSelections, "rowSelections")} */}
                              <label htmlFor={`dumpCheckbox-${product.materialId}`}>Yes</label>
                            </div>
                            <div className="check_box me-1" style={{ gap: "0" }}>
                              <input
                                className="form-check-input"
                                ...
                                // onChange={handleSelectAllNonMaterials}
                                // checked={allNonMaterialsSelected}
                                id={`storeCheckbox-${product.materialId}`}
                                onChange={() => handleCheckboxChange(product.materialId, "No")}
                                checked={rowSelections[product.materialId] === "Store"}
                                // onClick={() => handleEditClick(index)}
                              />
                              <label htmlFor={`storeCheckbox-${product.materialId}`}>No</label>
                            </div>
                          </div>
                          <div className="col_40p">
                            <div className="check_box me-1" style={{ gap: "0" }}>
                              <input
                                ...
                                // checked={allNonMaterialsSelected}
                                id={`dumpCheckbox-${product.materialId}`}
                                onChange={() => handleCheckboxChange(product.materialId, "Dump")}
                                checked={rowSelections[product.materialId] === "Dump"}
                                // onClick={() => handleEditClick(index)}
                              />
                              {/* {console.log(rowSelections, "rowSelections")} */}
                              <label htmlFor={`dumpCheckbox-${product.materialId}`}>Dump</label>
                            </div>
                            <div className="check_box me-1" style={{ gap: "0" }}>
                              <input
                                className="form-check-input"
                                ...
                                // checked={allNonMaterialsSelected}
                                id={`storeCheckbox-${product.materialId}`}
                                onChange={() => handleCheckboxChange(product.materialId, "Store")}
                                checked={rowSelections[product.materialId] === "Store"}
                                // onClick={() => handleEditClick(index)}
                              />
                              <label htmlFor={`storeCheckbox-${product.materialId}`}>Store</label>
                            </div>
                          </div>
                          <div className="col_25p">
          ...
          <div className="table_main">
            <div className="table_section pi_product_table" style={{ minWidth: "2000px" }}>
              ...
              <div className="table_data">
                ...
                <div className="col_25p">{/* <h6>{index + 1}</h6> */}</div>
                ...
                <div className="col_25p">{/* <h6>{item?.brand}</h6> */}</div>
                <div className="col_25p">{/* <h6>{item?.modelName}</h6> */}</div>
                <div className="col_25p">{/* <h6>{item?.serialNo}</h6> */}</div>
                <div className="col_20p">{/* <h6>{item?.itemCode}</h6> */}</div>
                <div className="col_40p">
                  <div className="position-relative">
                    {/* <select
                      value={item?.status}
                ...
                <div className="col_40p">
                  <div className="position-relative">
                    ...
                    >
                      ...
                      {blocks.map((block, idx) => {
                        return (
                          <option className="small text-capitalize" value={block._id} key={idx}>
                            {block.blockNo}
                          </option>
                        );
                      })}
