...
const ViewSalesOrder = ({ setModalStates, pdfData, toast }) => {
        ...
        <div className="kitchen_req_pdf_main p-4" ref={printPdfRef}>
          ...
          <div className="req_details">
            <div className="left_details">
              <h4>Customer Name : {pdfData?.customerName}</h4>
              <h4>Customer Number : {pdfData?.customerNo}</h4>
              <h4>Order Location :{pdfData?.orderLocation?.name}</h4>
              <h4>Order Taken Persons :{pdfData?.orderTakenBy?.name}</h4>
            </div>
            <div className="right_details">
              <h4>#{pdfData?.salesOrderNo}</h4>
            </div>
          </div>
          ...
          <div className="req_table_main">
            ...
            {pdfData?.materialDetails?.map((data, index) => {
              return (
                <div key={index} className="table_data">
                  ...
                  <div className=" data_col col_35p">
                    <h6>{data?.materialDescription}</h6>
                  </div>
                  <div className=" data_col col_25p">
                    <h6>{data?.quantity}</h6>
                  </div>
