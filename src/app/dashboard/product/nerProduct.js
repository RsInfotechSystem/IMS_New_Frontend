                        ...
                        {productList?.length > 0 ? (
                            <>
                                {productList?.map((data, index) => {
                                    return (
                                        <>
                                            <div className="table_data" key={index + 1} style={{ minWidth: "2000px" }}>
                                                <div className="col_10p">
                                                    <div className="check_box">
                                                        <input
                                                            className="form-check-input"
                                                ...
                                                <div className="table_data" style={{ flexDirection: "column", width: "20%" }} >
                                                    {
                                                        data.models?.map((model, ind) => {
                                                            return (

                                                                <div className="col_20p" style={{ borderBottom: " 1px solid var(--grey_color_light_shade1)" }}>
                                                                    <div className="model_div">
                                                                        <h6>{model?.name}</h6>
                                                                    </div>
                                                                </div>
