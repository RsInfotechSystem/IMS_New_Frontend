...
const PoList = () => {
  ...
  const getPOList = async (page, searchString) => {
    try {
      setLoader(true);
      const serverResponse = await communication.getPoList({ page, searchString });
  ...
  return (
    <>
      ...
      <div className="top_header">
        <div className="tab_title">Purchase Order List</div>
      </div>
      <div className="search_btn_wrapper">
        ...
        <div className="buttons_wrapper">
          <CustomBtn
            name={"Create"}
            onClick={() => {
              router.push("/dashboard/po-management/create-po");
            }}
            svg={
              <svg
                width="24"
                  ...
                  <div className="table_data" key={index}>
                    ...
                    <div className="col_20p">
                      <h6
                        onClick={() => {
                          router.push(
                            `/dashboard/po-management/create-po?poId=${data?._id}&type=approval`
                          );
                        }}
                      >
                    ...
                    <div className="col_30p">
                      <h6 className="action_wrraper">
                        ...
                        <div
                          title="edit"
                          onClick={() => {
                            router.push(`/dashboard/po-management/create-po?poId=${data?._id}`);
                          }}
                        >
                          <svg
                            width="27"
