...
const ViewPo = ({ data, setModalStates }) => {
  return (
    <>
        ...
        <div className="purchase_indent_view_wrapper">
          <div className="view_wrapper_header">
            <div className="d-flex align-items-center justify-content-center gap-2">
              ...
              <span className="text-secondary fw-medium">#{data?.orderId}</span>
            </div>
            <div className="d-flex align-items-center justify-content-center gap-2">
              {/* <span
            ...
            <div className="d-flex align-items-start justify-content-start gap-5 all_category_vendors_wrapper">
              <div className="fw-medium">
                ...
                <ol className="list-group" type="1">
                  <li className=" small text-secondary fw-light text-capitalize">{data?.name}</li>
                </ol>
              </div>
              <div className="fw-medium">
                Type
                ...
                <div className="table_main">
                  ...
                  <div className="table_section pi_view_product_table">
                    <div className="table_header">
                      ...
                      <div className="col_25p">
                        <h5 className="action_wrraper">Amount</h5>
                      </div>
                    </div>
                    {data?.item?.map((product, index) => {
                      return (
                        <div className="table_data" key={index}>
                          ...
                          <div className="col_25p">
                            <h6 className="action_wrraper">{product?.amount}</h6>
                          </div>
                        </div>
                      );
                    })}
