...
const VendorReport = () => {
    ...
    const fetchVendorReport = async () => {
        try {
            setLoader(true);
            const serverResponse = await communication.getVendorReport();
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart
                                        ...
                                        onClick={(event) => {
                                            ...
                                            if (payload?.vendorId) {
                                                router.push(`/dashboard/report/vendor-report-list?vendorId=${payload.vendorId}`);
                                            }
                                        }}
                                    >
                                        ...
                                        <Tooltip
                                            ...
                                            formatter={(value, name, props) => [
                                                ...
                                                // props.payload.vendorName,
                                            ]}
                                        />
                                        <Bar dataKey="totalRemainingQuantity" fill={primaryColor} radius={[4, 4, 0, 0]} barSize={80} />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </CardContent>
                    ...
                    >
                        <Card style={{
                            ...
                            <CardContent style={{ paddingTop: "1.5rem" }}>
                                ...
                                <p style={{ fontSize: "0.875rem", color: "#4b5563" }}>Vendors Shown</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card style={{ textAlign: "center", borderRadius: "1rem", }}>
                            <CardContent style={{ paddingTop: "1.5rem" }}>
                                ...
                                <p style={{ fontSize: "0.875rem", color: "#4b5563" }}>Average per Vendor</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
